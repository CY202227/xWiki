...
class SourceIndexer:
    ...
    async def _page_summary(
        self, page_no: int, content: str, inherited: str, doc_hash: str
    ):
        ...
        resp = self._llm.structured(
            messages=[
                ...
                {
                    "role": "user",
                    "content": f"Inherited Context: {inherited}\nPage Content:\n{content}",
                },
            ],
    ...
    async def index(self, document: ParsedDocument) -> None:
        ...
        for page in document.pages:
            ...
            page_summaries.append(
                {"page": page.page_no, "summary": summary.page_summary}
            )
